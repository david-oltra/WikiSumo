...
bool labVL53L0X::Init(VL53L0X_DeviceModes devMode, uint8_t VL53L0X_I2C_ADDRESS)
{
    ...
    setThresholds(tofRateValue[0], tofThresholdValue[0]);

    /* device init */
    vl53l0x_dev.i2c_port_num = i2c_port;
    vl53l0x_dev.i2c_address = VL53L0X_I2C_ADDRESS;
